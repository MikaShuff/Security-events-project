...
- Create Angular project with ng: `ng new securityincidents.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`securityincidents.client.esproj`).
